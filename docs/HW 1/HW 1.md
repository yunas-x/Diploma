...
5.	 Сообщение о решении пользователю. <br>
...
2.  Data Engineer загружает туда извлеченные данные.
3.  Data Engineer заполняет метаданные о парсере (целевой ВУЗ, формат данных).
4.  Система помечает данные в статусе <i>beta</i>. <br>
