...
<b> GET </b> <b>```/programs/fields```</b> — получить все направления подготовки высшего образования, по которым в системе существуют программы <br>
<br>
<i> Headers: </i> <br>
...
Field {
        ...
        field_name: string — название направления подготовки
        field_group_code: string(^[0-5][0-9]\.0{2}\.0{2}$) — код группы направлений подготовки
        field_group_name: string — название группы направлений подготовки
}
```
