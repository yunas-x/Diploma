...
1.	Выбор образовательной программы для анализа из числа загруженных на платформу.
...
4.  Data Engineer заполняет метаданные о данных (целевой ВУЗ, формат данных).
5.  Система помечает данные в статусе <i>beta</i>. <br>
